                    ...
                    <Nav className="me-auto">
                        ...
                        <Dropdown.Toggle as={Nav.Link} split/>
                            ...
                            <Dropdown.Item eventKey="2"><Link className="nav" to={"/CourseReviewsPage"}>Course Reviews Application</Link></Dropdown.Item>
                                ...
                                <Dropdown.Item eventKey="5"><Link className="nav" to={"/RoulettePage"}>Roulette.FM</Link></Dropdown.Item>
                                <Dropdown.Item eventKey="6"><Link className="nav" to={"/KOPage"}>24KO</Link></Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
